...
ALLOWED_HOSTS = ['django-greatkart-env.eba-mkcnpbmq.us-west-2.elasticbeanstalk.com','*']
# 
...
else:   # Production on Elastic Beanstalk
    DATABASES = {
        'default': {
...
EMAIL_PORT=config('EMAIL_PORT', default=True, cast=int)
